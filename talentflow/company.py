...
def page_company_dashboard(data: dict, company_id: int):
    ...
    hero(f"{info['name']}", f"Shortlist health — {info['industry']} | HQ: {info['hq']}", eyebrow="Company Dashboard")
    ...
    with col_right:
        ...
        fig = px.bar(top, x="Demand", y="Skill", orientation="h", color_discrete_sequence=["#7c3aed"])
